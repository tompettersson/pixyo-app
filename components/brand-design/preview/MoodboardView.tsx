...
export default function MoodboardView({ tokens, profileName }: MoodboardViewProps) {
  const { colors, typography, spacing, borders, shadows, components, voice } = tokens;
    ...
    <div className="space-y-8">
      ...
      >
        ...
        <div className="space-y-3">
          {[
            ...
            <div key={level.label} className="flex items-baseline gap-3">
              ...
              <span
                style={{
                  fontFamily: `'${typography.fonts.heading.family}', ${typography.fonts.heading.fallback}`,
                  fontSize: level.size,
        ...
        <div className="mt-6 space-y-2">
          <p
            style={{
              fontFamily: `'${typography.fonts.body.family}', ${typography.fonts.body.fallback}`,
          ...
          >
            Body Text — Dies ist ein Beispiel für den Fließtext. Die Schriftart{' '}
            <strong style={{ fontWeight: typography.fontWeights.bold }}>
              {typography.fonts.body.family}
            </strong>{' '}
            in {typography.scale.base}px mit einem Zeilenabstand von {typography.lineHeight.normal}.
          </p>
          <p
            style={{
              fontFamily: `'${typography.fonts.body.family}', ${typography.fonts.body.fallback}`,
            ...
            {['sm', 'md', 'lg', 'xl', 'full'].map((key) => (
              <div key={key} className="text-center">
                <div
                  ...
                  style={{
                    borderRadius: borders.radius[key as keyof typeof borders.radius],
      ...
      <section>
        ...
        >
          ...
          >
            ...
            Schatten, Radius und Padding sind live anpassbar.
          </p>
          <button
            style={{
              background: components.button.primary.background,
              color: components.button.primary.color,
              border: components.button.primary.border === 'none' ? 'none' : components.button.primary.border,
        ...
        >
          ...
          <input
            ...
            style={{
              ...
              fontFamily: `'${typography.fonts.body.family}', ${typography.fonts.body.fallback}`,
              fontSize: `${typography.scale.base}px`,
              color: colors.semantic.text.default,
              outline: 'none',
            }}
          />
          ...
          <div className="bg-zinc-900 rounded-xl p-4 space-y-2">
            ...
            {voice.tone.length > 0 && (
              <div className="flex flex-wrap gap-1.5">
                {voice.tone.map((t, i) => (
                  <span key={i} className="px-2 py-0.5 bg-zinc-800 text-xs text-zinc-300 rounded-md">
                    {t}
                  </span>
                ))}
              </div>
