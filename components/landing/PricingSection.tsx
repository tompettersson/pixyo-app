...
const tiers = [
  {
    ...
    price: '0',
    period: 'Kostenlos',
    description: 'Zum Ausprobieren. Genug um zu sehen, was Pixyo kann.',
    features: [
      '1 Projekt',
      '20 KI-Generierungen / Monat',
      '3 Banner-Exporte / Monat',
  ...
  },
  {
    ...
    price: '49',
    period: '/ Monat',
    description: 'Für Teams und Agenturen, die täglich produzieren.',
    features: [
      'Unbegrenzte Projekte',
      '500 KI-Generierungen / Monat',
      'Unbegrenzte Banner-Exporte',
      '10 Brand-Design-Profile',
