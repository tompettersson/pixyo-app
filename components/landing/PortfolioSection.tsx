...
const projects = [
  ...
  {
    number: '05',
    title: 'Shopware Command Center',
    description: 'Shopware-Daten ziehen, verändern, mit KI verarbeiten, KI-Bilder generieren — alles aus einer Oberfläche. Die Zentrale für Shopware-Power-User.',
    tags: ['SaaS', 'Shopware 6', 'KI-Integration', 'Datenverarbeitung'],
    label: 'Shoptic',
  },
  {
    number: '06',
